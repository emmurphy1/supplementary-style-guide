// Ceph: Added "In Red{nbsp}Hat Ceph Storage, RADOS is"
[[rados]]
...
// Ceph: Added "In Red{nbsp}Hat Ceph Storage, the RADOS Block Device is"
[[rados-block-device]]
...
// Ceph: Added "In Red{nbsp}Hat Ceph Storage, RADOS Gateway is"
[[rados-gateway]]
...
// Ceph: Added "In Red{nbsp}Hat Ceph Storage, RBD is an"
[[RBD]]
...
// Ceph: Added "In Red{nbsp}Hat Ceph Storage, `rbd` is"
[[rbd]]
==== image:images/yes.png[yes] rbd (noun)
...
// Ceph: Added "In Red{nbsp}Hat Ceph Storage,"
// Combined entries
[[realm]]
...
// BxMS: Added "In Red{nbsp}Hat Process Automation Manager and Red{nbsp}Hat Decision Manager,"
[[realtime-decision-server]]
==== image:images/yes.png[yes] Realtime Decision Server (noun)
*Description*: In Red{nbsp}Hat Decision Manager and Red{nbsp}Hat Process Automatio M, the _Realtime Decision Server_ is a standalone, built-in component that can be used to instantiate and execute rules through interfaces available for REST, JMS, or a Java client-side applications. Created as a web deployable WAR file, this server can be deployed on any web container. The current version of the Realtime Decision Server is included with default extensions for both Red{nbsp}Hat Decision Manager and Red{nbsp}Hat Process Automatio M.
...
// AMQ: Added "In Red{nbsp}Hat AMQ, a receiver is"
[[receiver]]
...
[discrete]
[[rhdm]]
==== image:images/yes.png[yes] Red{nbsp}Hat Decision Manager (noun)
*Description*: _Red{nbsp}Hat Decision Manager_ is a comprehensive platform for business rules management, business resource optimization, and complex event processing (CEP). Red{nbsp}Hat Decision Manager is a subset of Red{nbsp}Hat Process Automation Manager. Organizations can use Red{nbsp}Hat Decision Manager to incorporate sophisticated decision logic into line-of-business applications and quickly update underlying business rules as market conditions change.
...
*See also*: xref:bpms[Red{nbsp}Hat Process Automation Manager]
...
// Fuse: Added new entry for "Red{nbsp}Hat Fuse Online" (Breda)
[[red-hat-fuse-online]]
...
// BxMS: General; kept as is
[[bpms]]
==== image:images/yes.png[yes] Red{nbsp}Hat Process Automation Manager (noun)
*Description*: _Red{nbsp}Hat Process Automation Manager_ is the Red{nbsp}Hat platform for Business Process Management (BPM). With Red{nbsp}Hat Process Automation Manager enterprise business and IT users can document, simulate, manage, automate, and monitor business processes and policies. It is designed to empower business and IT users to collaborate more effectively, so business applications can be changed more easily and quickly.
...
*See also*: xref:rhdm[Red{nbsp}Hat Decision Manager]
...
// EAP: Added "In Red{nbsp}Hat JBoss Enterprise Application Platform,"
[[remoting]]
...
// RHDS: Added "In Red{nbsp}Hat Directory Server,"
[[replica]]
...
// RHEL: Added "In Red{nbsp}Hat Enterprise Linux,"
...
// OCP: Added "In Red{nbsp}Hat OpenShift, a replication controller is"
...
// Ceph: Added "In Red{nbsp}Hat Ceph Storage, RGW is an"
[[rgw]]
...
// OCS: Added "In Red{nbsp}Hat OpenShift Container Storage,"
[[rook-ceph-operator]]
...
// OCP: Added "In Red{nbsp}Hat OpenShift,"
// Fuse: Added "In Red{nbsp}Hat Fuse," and removed "In Camel"
// Combined
[[route]]
...
// AMQ: Added "In Red{nbsp}Hat AMQ, a router is"
[[router]]
...
// Fuse: Added "In Red{nbsp}Hat Fuse,"
...
// AMQ: Added "In Red{nbsp}Hat AMQ, a routing mechanism is"
[[routing-mechanism]]
...
// AMQ: Added "In Red{nbsp}Hat AMQ, a routing pattern is"
[[routing-pattern]]
...
*Description*: In Red{nbsp}Hat Decision Manager and Red{nbsp}Hat Process Automatio M, a _rule_ provides the logic for the rule engine to execute against. A rule includes a name, attributes, a “when” statement on the left side of the rule, and a “then” statement on the right side of the rule.
...
*Description*: In Red{nbsp}Hat Decision Manager and Red{nbsp}Hat Process Automatio M, a _rule template_ enables the user to define a rule structure. Rule templates provide a placeholder for values and data, and they populate templates to generate many rules.
